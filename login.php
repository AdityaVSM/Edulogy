<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		if(!empty($user_name) && !empty($password)){
			...
			echo "<p style='color:red; text-align:center; font-size:25px; position:relative; top:550px; left:-50px;'>" . "Wrong username or password!" ."</p>";
		}else{
			echo "<p style='color:red; text-align:center; font-size:25px; position:relative; top:550px; left:-50px;'>Please enter valid information!</p>";
		}
	}
?>
<!DOCTYPE html>
