...
<html>
    ...
    <body >
        ...
        <a href="cppbasics.php" target="_blank"><button type="button" class="prev btn btn-primary btn-lg"> << Prev(C++ environment setup)</button></a>
        <a href="cppsyntax.php" target="_blank"><button type="button" class="next btn btn-primary btn-lg">Next(C++ syntax)>></button></a>
